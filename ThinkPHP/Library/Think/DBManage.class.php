    ...
    {   
            ...
            {   
                ...
                {   
                    ...
                    {   
                        ...
                        //echo "表-" . $tablename . "-卷-" . $p . "-数据备份完成,生成备份文件 <a style='color:#f00;'>$dir$filename</a><br />";   
        ...
        { // 备份全部表   
            ...
            {   
                ...
                {   
                    ...
                    {   
                        ...
                        if ($this->_write_file ( $sql, $file, $dir ))   
                        {   
                            //echo "-卷-" . $p . "-数据备份完成,生成备份文件<a style='color:#f00;'>$dir$file</a><br />";   
                        }   
                        else  
                        {   
                            echo "备份卷-" . $p . "-失败<br />";   
            ...
            {   
                ...
                if ($this->_write_file ( $sql, $filename, $dir ))   
                {   
                    //echo "-卷-" . $p . "-数据备份完成,生成备份文件 <a style='color:#f00;' href='{:U(\'Db/download\'),array(\'$file\'=>$dir$filename)}'>$dir$filename</a><br />";   
                }   
                else  
                {   
                    echo "备份卷-" . $p . "-失败<br />";   
        ...
        {   
            ...
            {   
                ...
                if (file_exists ( $tmpfile )) {   
                    // 执行导入方法   
                    $msg.= "正在导入分卷<span style='color:#f00;'>" . $tmpfile . '</span><br />';   
