...
<div class="zhinanbox">
	<div class="zhinan">
    	<div class="left">
			<?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?><div class="link">
					<h2><?php echo ($art["type_name"]); ?></h2>
					<div class="linka">
						<?php if(is_array($art["info"])): $i = 0; $__LIST__ = $art["info"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Article/Detail',array('type_id'=>$a['type_id']));?>" <?php if($current == $a['type_name']): ?>class="current"<?php endif; ?>><?php echo ($a["type_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
...
<!--zhinanbox结束-->     
	...
	<div class="right">
		<h2><?php echo ($arcinfo["arc_title"]); ?></h2>
		<h6>版本生效日期：<?php echo ($arcinfo["pubtime"]); ?></h6>
