...
<div class="right">
        <div class="dingdanbox">
        	<div class="title">
                ...
                <a href="center-dingdan-wc.html" class="current">交易完成</a>
            </div>
            <div class="sousou">
            	<div class="ss">
                	<input type="text">
                ...
                <div class="cpbox">
                    <div class="cp">
                        ...
                        <ul>
                            ...
                            <li class="w7 br1 tac">
                            	<h3>交易成功</h3>
                                <a class="xq" href="<?php echo U('Order/Orderdetail',array('status'=>4));?>">订单详情</a>
                            </li>
                            <li class="w8">
                    ...
                    <div class="cp">
                        ...
                        <ul>
                            ...
                            <li class="w7 br1 tac">
                            	<h3>交易成功</h3>
                                <a class="xq" href="<?php echo U('Order/Orderdetail',array('status'=>4));?>">订单详情</a></li>
                            <li class="w8">
                            	<input type="button" class="pj" value="申请换货">
                            </li>
                        </ul>
			...
			$(function(){
				...
				//申请换货的页面跳转
				$(".pj").click(function(){
					location.href="<?php echo U('User/Apply');?>";
				});
			}); 
			</script>
        </div>
