     ...
     <!-- Removing search and results count filter -->
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">广告 广告添加 -- AD Add</div>
						<div class="panel-body">
							<div class="col-sm-5">
								<a href="<?php echo U('Ad/adsadd');?>"><button class="btn btn-success">广告添加 -- AD Add</button></a>
							</div>
						</div>
					</div>	
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">广告列表 -- AD List</h3>
				</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped" id="example-2">
						<thead>
							...
							<?php if(is_array($result)): foreach($result as $key=>$v): ?><tbody class="middle-align">
							...
							<tr>
								...
								<td>
									<a href="<?php echo U('Ad/adsupdate',array('id'=>$v['id']));?>" class="btn btn-secondary btn-sm btn-icon icon-left">
										编辑
									</a>
									
									<a href="javascript:del(<?php echo ($v["id"]); ?>);" class="btn btn-danger btn-sm btn-icon icon-left">
										删除
									</a>
								</td>
							</tr>
...
<script>
 ...
 function del(id)
    {     
        ...
        {
          window.location.href="<?php echo U('Ad/adsdelete','','');?>/id/"+id;     
        }
    }
</script>
