...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">权限 设置 -- auth Config </div>
            <div class="panel-body">
                <div class="col-sm-12">
                    <div class="col-sm-2">后台权区域：
                    </div>
                    <style>
                        .col-sm-10 label{margin-bottom:17px;}
                    </style>
                    <div class="col-sm-10">
                        <label  style="cursor:pointer; margin-right:3%;" for="minimal-checkbox-1-11">全选</label>
                        <?php if(is_array($quax_rows)): foreach($quax_rows as $key=>$vo): ?><label style="cursor:pointer;">
                                <input value="<?php echo ($vo["id"]); ?>" tabindex="5" type="checkbox" <?php echo ($vo["checked"]); ?> class="icheck-11" id="minimal-checkbox-1-11">
                                <?php echo ($vo["title"]); ?>
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-4">
                    <button class="btn btn-secondary qd" data-original-title="点击确定将保存修改内容" title="" data-placement="bottom" data-toggle="tooltip" type="button">确定</button>	
                </div>
                <div class="col-sm-4"></div>									
            </div>
        </div>
...
<script>
    ...
    $(function () {
        $('.qd').click(function () {
            var xz = '';
            var zhi = '';
            var a = $('input:checked').each(function (i) {
                zhi = $(this).val();
                if (zhi != 'on') {
                    xz += ("," + zhi);
                }
            });
            $.post('/Admin/Auth/indexexe', {
                id: <?php echo ($id); ?>,
                xz: xz
            }, function (data) {
                if (data == 1) {
