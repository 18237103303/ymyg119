     ...
     <!-- Removing search and results count filter -->
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<button class="btn btn-turquoise" onclick="select()">查询</button>		
					...
					<table class="table table-bordered table-striped" id="example">
						...
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<a href="<?php echo U('Article/edit');?>?id=<?php echo ($vo["arc_id"]); ?>" class="btn btn-secondary btn-sm  btn-icon icon-left ">
										编辑
									</a>									
								</td>
...
function select(){
    ...
    window.location.href="<?php echo U('Article/article');?>?cid="+cat_id;
}
</script>
