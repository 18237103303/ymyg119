...
<!-- 弹出层 -->
<!-- Bottom Scripts -->
<link rel="stylesheet" href="/Public/admin/assets/js/jqwidgets/styles/jqx.base.css" type="text/css" />
        <script type="text/javascript" src="/Public/admin/assets/js/jqwidgets/jqxcore.js"></script>
    <script type="text/javascript" src="/Public/admin/assets/js/jqwidgets/jqxdata.js"></script>
    <script type="text/javascript" src="/Public/admin/assets/js/jqwidgets/jqxbuttons.js"></script>
    <script type="text/javascript" src="/Public/admin/assets/js/jqwidgets/jqxscrollbar.js"></script>
    <script type="text/javascript" src="/Public/admin/assets/js/jqwidgets/jqxdatatable.js"></script>
    <script type="text/javascript" src="/Public/admin/assets/js/jqwidgets/jqxtreegrid.js"></script>
        <script type="text/javascript" src="/Public/admin/assets/js/jqwidgets/jqxlistbox.js"></script>
    <script type="text/javascript" src="/Public/admin/assets/js/jqwidgets/jqxdropdownlist.js"></script>
<script src="/Public/admin/assets/js/bootbox/bootbox.min.js"></script>
                ...
                success: {
                    ...
                    callback: function() {
                        ...
                        $.ajax({
                            ...
                            'data':'cat_name='+cate,
                            'dataType':"json",
                            'url':"<?php echo U('Attr/addcate');?>",
                            'success':function(dat){
                                if(dat.status==1){
                                    bootbox.alert('添加成功');
                                    var url="<?php echo U('Attr/index');?>";
                    ...
                    callback: function() {
                       var cate=$('#cate_input').val();
                        ...
                        $.ajax({
                            ...
                            'dataType':"json",
                            'url':"<?php echo U('Attr/addcate_child');?>",
                            'success':function(dat){
                                if(dat.status==1){
                                    bootbox.alert('添加成功');
                                    var url="<?php echo U('Attr/index');?>";
...
function drop(id){
    $.ajax({
                            ...
                            'data':'id='+id,
                            'dataType':"json",
                            'url':"<?php echo U('Attr/deletecate');?>",
                            'success':function(dat){
                                if(dat.info==1){
                                    bootbox.alert('删除成功');
                                    var url="<?php echo U('Attr/index');?>";
