                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-sm-5">
                                ...
                                <a href="<?php echo U('Sys/navshop');?>" class="btn btn-success">网店导航列表 -- NET Position List</a>
                            </div>
                        </div>
                    </div>  
                </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <table class="table table-bordered table-striped" id="example-2">
                ...
                <?php if(empty($show["shop_name"])): ?><input class="form-control" type="text" name="shop_name" id="name"  value="<?php echo ($show["shop_name"]); ?>" onblur="checkname()" style="width:50%;float:left;">
                    <?php else: ?>
                    <input class="form-control" type="text" name="shop_name" id="name"  value="<?php echo ($show["shop_name"]); ?>" onblur="checkname()" style="width:50%;float:left;" disabled><?php endif; ?>
                        
                        <div id="showcheck"  style="width:30%;float:left;" >
                            
                        </div></td></tr>
                <tr><td>商店标题：</td><td><input class="form-control" type="text" id="title" name="shop_title"  value="<?php echo ($show["shop_title"]); ?>"></td></tr>
                <tr><td>商店描述：</td><td><input class="form-control" type="text" name="shop_desc" id="desc" value="<?php echo ($show["shop_desc"]); ?>"></td></tr>
                <tr><td>商店关键词：</td><td><input class="form-control" type="text" name="shop_keywords" id="keywords" value="<?php echo ($show["shop_keywords"]); ?>"></td></tr>
                ...
                <tr><td>商店详细信息</td><td><input class="form-control" type="text" id="detail"  name="shop_detail" value="<?php echo ($show["shop_detail"]); ?>"></td></tr>
                <tr><td>商店QQ号：</td><td> <input class="form-control" type="text" id="qq"  name="qq" value="<?php echo ($show["shop_qq"]); ?>"></td></tr>
                <tr><td>商店缩略图：</td><td><div><input  type="file" id="files" name='upload' data-url="<?php echo U('Sys/upload');?>" style="width:200px;float:left;"></div></td></tr>
                <tr><td colspan="2"><button class="btn btn-success" type="button" data-toggle="tooltip" data-placement="bottom" onclick="add()"/>确认提交</button><input type="hidden" value="<?php echo ($show["shop_id"]); ?>" id="shop_id"/> </td></tr>
            </table>
        </div>
    </div>	
</div>
<link rel="stylesheet" href="/Public/admin/assets/js/select2/select2.css">
<link rel="stylesheet" href="/Public/admin/assets/js/select2/select2-bootstrap.css">
                    ...
                    $(function () {
                        ...
                        $('#files').fileupload({
                            ...
                            dataType: 'json',
                                ...
                                $('#files').parent().append('<img src="/Uploads/' + data.result.path + '" style="width:120px;height:30px;float:left;"  id="upload_pic" path="' + data.result.path + '"/>')
                            },
                            complete: function () {
