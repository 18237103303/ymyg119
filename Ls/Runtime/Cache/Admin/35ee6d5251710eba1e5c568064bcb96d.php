				...
				<div class="panel-body">
					...
					<table class="table table-bordered table-striped" id="example">
						...
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>							
								...
								<td>
									<a href="<?php echo U('Article/editbulist');?>?id=<?php echo ($vo["arc_id"]); ?>" class="btn btn-secondary btn-sm  btn-icon icon-left ">
										编辑
									</a>
									<a href="<?php echo U('Article/scgg');?>?id=<?php echo ($vo["arc_id"]); ?>" class="btn btn-secondary btn-sm  btn-icon icon-left ">
										删除
									</a>									
								</td>
...
function select(){
    ...
    window.location.href="<?php echo U('Article/');?>?cid="+cat_id;
}
</script>
