...
<script>				
function shy(){
location.href="<?php echo U('Admin/User/mlist',array('type'=>1));?>";
}
function ghs(){
location.href="<?php echo U('Admin/User/mlist',array('type'=>2));?>";
}
function fwd(){
location.href="<?php echo U('Admin/User/mlist',array('type'=>3));?>";
}
function pthy(){
location.href="<?php echo U('Admin/User/mlist',array('type'=>4));?>";
}
function qb(){
location.href="<?php echo U('Admin/User/mlist',array('type'=>6));?>";
}
function tf(){
location.href="<?php echo U('Admin/User/mlist',array('type'=>5));?>";
}
function kf(){
location.href="<?php echo U('Admin/User/mlist',array('type'=>8));?>";
}
...
//$('input[name=cx]').keyup(function(){var a= $(this).val().replace(/\W/g,'');$(this).val(a);})
		...
		<?php if(is_array($rows)): foreach($rows as $key=>$vo): ?><tr>
						<!-- 		<td>
								...
								<td>ID：<span><?php echo ($vo["id"]); ?></span></td>
								<td><input  type="text" name="name" value="<?php echo ($vo["name"]); ?>" disabled></td>
								<td><input type="text" name="phone"value="<?php echo ($vo["phone"]); ?>"/>
								</td>
								<td><input type="text" name="email" value="<?php echo ($vo["email"]); ?>"/></td>
								<!-- <td><?php echo ($vo["address"]); ?></td> -->
								<!-- <td><?php echo ($vo["jf"]); ?></td> -->
								<!-- <td><?php echo ($vo["dj_jf"]); ?></td> -->
								<!-- <td><?php echo ($vo["up_id"]); ?></td> <?php echo ($vo["grand"]); ?>-->
								<td>
								<?php echo ($vo["grand"]); ?>
								</td>
								<td><?php echo ($vo["l_time"]); ?></td>
								<!-- <td><?php echo ($vo["user_addr"]); ?></td> -->
								...
								<td>
									...
									<a href="<?php echo U('User/userexe',array('id'=>$vo['id'],'type'=>3));?>" class="btn btn-danger btn-sm btn-icon icon-left">
										删除
									</a>
									<?php if($tf != 'kq' ): ?><a href="<?php echo U('User/userexe',array('id'=>$vo['id'],'type'=>4));?>" class="btn btn-warning btn-sm btn-icon icon-left">
										封停
									</a>
									<?php else: ?>
									<a href="<?php echo U('User/userexe',array('id'=>$vo['id'],'type'=>5));?>" class="btn btn-secondary btn-sm btn-icon icon-left">
										启用
									</a><?php endif; ?>
								</td>
