...
<script src="/Public/admin/assets/js/jquery.PrintArea.js" type="text/javascript"></script>
<script>
     $('#order').jqGrid({
        url: "<?php echo U('Order/fw_list');?>",
        datatype: "json",
        colModel: [
        ...
        subGridRowExpanded: function (subgrid_id, row_id) {
            ...
            $('#attr' + rowData.order_id).jqGrid({
                url: "<?php echo U('Order/fw_list');?>?type=item&order_id="+ rowData.order_id,
                datatype: "json",
                colModel: [
                ...
                buttons: {
                    success: {
                        ...
                        callback: function() {
                            ...
                            $.post("<?php echo U('Order/send');?>",{order_id:rdata.order_id,type:'send',send_id:send_id},function(data){
                                dat = eval('('+data+')');
                ...
                buttons: {
                    success: {
                        ...
                        callback: function() {
                            ...
                            $.post("<?php echo U('Order/send');?>",{type:'resend',send_id:send_id},function(data){
                                dat = eval('('+data+')');
                                bootbox.alert(dat.msg);
                            });
                        }
        ...
        bootbox.dialog({
                ...
                buttons: {
                    success: {
                        ...
                        className: "btn-success",
                        callback: function() {
                            $.post("<?php echo U('Order/send');?>",{order_id:rdata.order_id,type:'sure'},function(data){
                                dat = eval('('+data+')');
                                bootbox.alert(dat.msg);
                            });
                        }
