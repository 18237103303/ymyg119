...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">权限/角色- Member List</h3>					
    </div>
    <div class="panel-body">
        <table class="table table-bordered table-striped" id="example-2">
            ...
            <?php if(is_array($rows)): foreach($rows as $key=>$vo): ?><tr>
                    ...
                    <td><?php echo ($vo["quanx"]); ?></td>
                    <td><textarea><?php echo ($vo["comment"]); ?></textarea></td>
                    <td>
                        <a href="<?php echo U('Auth/index',array('id'=>$vo['id'],'yc'=>'asa'));?>" class="btn btn-secondary btn-sm btn-icon icon-left">
                            授权
                        </a>
                        <a href="<?php echo U('Auth/index',array('id'=>$vo['id'],'yc'=>'ass'));?>" class="btn btn-danger btn-sm btn-icon icon-left">
                            删除
                        </a>
                    </td>
        ...
        <span style="color:red">此页面禁止刷新 修改过后请重新进入</span></br>
        <!-- <button class="btn btn-turquoise" onclick="jQuery('#modal-7').modal('show', {backdrop: 'static'});">新增角色 - Add</button> -->
    </div>
</div>
<!-- 弹出层 -->
<script>
