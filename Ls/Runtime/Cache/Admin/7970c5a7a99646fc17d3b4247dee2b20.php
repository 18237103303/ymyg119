          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="col-sm-5">
                ...
                <a href="<?php echo U('Ad/adsindex');?>"><button class="btn btn-success">广告列表查看 -- AD List</button></a>
              </div>
            </div>
          </div>  
        </div>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form  role="form" class="form-horizontal" action="<?php echo U('Ad/adsupdate');?>" method="post" enctype="multipart/form-data" onsubmit="return checkform()">
								<div class="form-group">
								<input type="hidden" name='id' value="<?php echo ($date["id"]); ?>">
									<label class="col-sm-2 control-label" for="field-1">广告标题</label>
									
									<div class="col-sm-10"><input class="form-control" type="text" name="name" id="name" value="<?php echo ($date["name"]); ?>">
							        </div>
								</div>
								...
								<div class="form-group has-info">
									...
									<div class="col-sm-10">
								            ...
								            <?php if(is_array($position_name)): foreach($position_name as $key=>$v): ?><option value="<?php echo ($v["position_id"]); ?>"><?php echo ($v["position_name"]); ?></option><?php endforeach; endif; ?>
                                            </select>
                                    </div>
								</div>
								...
								<div class="form-group has-info">
									<label class="col-sm-2 control-label" for="field-9">广告链接</label>
									 ...
									 <div class="col-sm-10">
									 	<input class="form-control" type="text" id="url" name="ad_link" value="<?php echo ($date["ad_link"]); ?>">
									</div>
								</div>
								<div class="form-group-separator"></div>
								<?php if($date['ad_type'] == 0): ?><div class="form-group has-error" id="0">
								...
								<div class="form-group has-error">
									<label class="col-sm-2 control-label" for="field-10">已经上传图片</label>
									
							    <div class="col-sm-10">
                                <img src="/Uploads/<?php echo ($date["ad_code"]); ?>" style="width:80px;height:50px" alt="原图的小图展示" title="原图的小图展示">
								</div>
								</div><?php endif; ?>
								<div class="form-group has-info">
							    ...
							    <div class="col-sm-10">
							    	<input class="form-control" type="text" id="sort"  name="sort" value="<?php echo ($date["sort"]); ?>">
								</div>
								</div>
								<div class="form-group-separator"></div>
								<div class="form-group">	
									<input type="submit" class="btn btn-info btn-single pull-right" value="确认修改">
								</div>
							</form>
						</div>
					</div>
