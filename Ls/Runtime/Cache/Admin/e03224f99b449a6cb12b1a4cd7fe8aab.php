...
<div class="panel-body">
    <label class="col-sm-3 control-label" for="field-1">填写年份按季度统计</label>
    <form action="<?php echo U('Goods/salecount');?>"  method="post">
   <button type="submit" class="btn btn-warning btn-sm btn-icon icon-left">
        查询
    </button>

    <div class="col-sm-10">
        <input class=" datepicker" type="text" name='stime'  placeholder="例如：2015"/>
...
<script src="/Public/admin/assets/js/devexpress-web-14.1/js/globalize.min.js"></script>
<script src="/Public/admin/assets/js/devexpress-web-14.1/js/dx.chartjs.js"></script>
