    ...
    <div class="panel-body">
        ...
        <table class="table table-bordered table-striped" id="example-2">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <?php if($vo['is_alone_sale'] == 1): ?><img src="/Public/admin/assets/images/right.png" width="15"/>
                            <?php else: ?>
                            <img src="/Public/admin/assets/images/error.png" width='15'/><?php endif; ?>
                    </td>
                    <td>
                        <?php if($vo['is_best'] == 1): ?><img src="/Public/admin/assets/images/right.png" width="15"/>
                            <?php else: ?>
                            <img src="/Public/admin/assets/images/error.png" width='15'/><?php endif; ?>
                    </td>
                    <td>
                        <a href="###" class="btn btn-secondary btn-sm btn-icon icon-left" onclick="edit(<?php echo ($vo["goods_id"]); ?>)">
                            编辑
                        </a>
                        <a href="<?php echo U('Goods/sys',array('gid'=>$vo['goods_id'],'type'=>delete));?>" class="btn btn-danger btn-sm btn-icon icon-left">
                            删除
                        </a>
                    </td>
                ...
                success: {
                    ...
                    callback: function() {
                        ...
                        $.ajax({
                            ...
                            'dataType':"json",
                            'url':"<?php echo U('Goods/sys');?>",
                            'success':function(dat){
                                // var data = eval('(' + dat + ')');
                                if(dat.info==1){
                                    bootbox.alert('添加成功');
                                    var url="<?php echo U('Goods/index_sys');?>";
