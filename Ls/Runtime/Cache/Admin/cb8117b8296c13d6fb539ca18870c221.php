    ...
    <div class="panel-body">
        <table class="table table-bordered table-striped" id="example-2">
            ...
            <?php if(is_array($rows)): foreach($rows as $key=>$vo): ?><tr>
                    ...
                    <td><?php echo ($vo["rules1"]); ?></td>
                    <td>
                        <a href="##" att="<?php echo ($vo["cat_id"]); ?>"  class="btn sx btn-secondary btn-sm btn-icon icon-left">
                            属性设置
                        </a>
                        <a href="/Admin/Attr/dorp/id/<?php echo ($vo["cat_id"]); ?>" class="btn btn-danger btn-sm btn-icon icon-left">
                            删除
                        </a>
                    </td>
                    ...
                    success: {
                        ...
                        callback: function() {
                           ...
                           $.ajax({
                                ...
                                'data':'id='+id+'&zhi='+b,
                                'dataType':"json",
                                'url':"<?php echo U('Attr/grand');?>",
                                'success':function(dat){
                                    // var data = eval('(' + dat + ')');
                                    if(dat.info==1){
                                        bootbox.alert('更新成功');
                                        var url="<?php echo U('Attr/grand');?>";
