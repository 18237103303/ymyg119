			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<table class="table table-bordered table-striped" id="example-2">
						<tr><td style="width:15%;">网点编号</td><td id="bh"><?php echo ($row["id"]); ?></td></tr>
						<tr><td>网点名字</td><td><?php echo ($row["name"]); ?></td></tr>
                        <tr><td>城市地址</td>
                            <td>
                    ...
                    <button class="btn btn-secondary btn-sm btn-icon icon-left dztz" style="margin-left: 3%;">调整</button>
                        ...
                        <tr><td>佣金</td><td>￥<em><?php echo ($row["yj"]); ?></em>&nbsp;&nbsp;<i id="yj" style="cursor:pointer;">[详情信息]</i></td></tr>
                        <tr><td>冻结佣金</td><td>￥<em><?php echo ($row["dj_yj"]); ?></em>&nbsp;&nbsp;<i id="dj_yj" style="cursor:pointer;">[详情信息]</i></td></td></tr>
