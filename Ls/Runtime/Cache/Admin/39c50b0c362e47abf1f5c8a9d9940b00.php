				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form  role="form" class="form-horizontal" action="<?php echo U('Ad/adsadd');?>" method="post" enctype="multipart/form-data" onsubmit="return checkform()">
								...
								<div class="form-group has-info">
									...
									<div class="col-sm-10">
								            <select class="form-control" name="position_name" id="position_id">            
							    ...
							    <div class="col-sm-10">
							    	<input class="form-control" type="text" id="sort"  name="sort" placeholder="数字越大，在页面中的楼层广告越靠前（也可以不填）">
								</div>
								</div>
								<div class="form-group">
...
<script>
 ...
 var reg4=new RegExp(/^([\u4E00-\uFA29]*[a-z]*[A-Z]*[0-9]*\s*)+$/g);
...
return false;
 								...
 								if(dat.status==1){
                                    bootbox.alert('添加成功');
                                    var url="<?php echo U('Ad/adposition');?>";
