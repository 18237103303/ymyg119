				...
				<div class="panel-body">
					<table class="table table-bordered table-striped" id="example-2">
						<thead>
							...
							<?php if(is_array($position)): foreach($position as $key=>$v): ?><tbody class="middle-align">
					
							<tr>
								<td><?php echo ($v["position_name"]); ?></td>
								<td><?php echo ($v["position_describe"]); ?></td>
                            
								<td>
									<a href="###" class="btn btn-secondary btn-sm btn-icon icon-left" onclick="edit(<?php echo ($v["position_id"]); ?>,this)">
										编辑
									</a>
									<!-- <a href="###" class="btn btn-secondary btn-sm  btn-icon icon-left"  onclick="del(<?php echo ($v["position_id"]); ?>)">
										删除
									</a>	 -->
								</td>
							</tr>
