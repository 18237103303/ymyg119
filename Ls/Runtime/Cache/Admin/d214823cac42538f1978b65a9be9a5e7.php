...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="col-sm-5">
             <a href="<?php echo U('Goods/edit',array('id'=>$_SESSION['upgid']));?>"><button class="btn btn-success">返回商品修改页面</button></a>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo U('Goods/gabout_edit',array('type'=>'select','id'=>$_SESSION['upgid']));?>" method="post">
                          <!--   <input type="hidden" name="id" value="<?php echo ($data1["0"]["goods_id"]); ?>"/> -->
