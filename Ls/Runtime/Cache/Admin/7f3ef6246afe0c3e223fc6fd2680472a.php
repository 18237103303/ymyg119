    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="<?php echo U('Index/index');?>">后台管理</a> --<?php echo ($url_here); ?>
            </div>

            <div class="panel-body">
                <div class="col-sm-7">
                    <a class='btn btn-turquoise' href="<?php echo U('Brand/add');?>">新增品牌-Add</a>
                </div>
    ...
    <div class="panel-body">
        <table id="example-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vo["navtype"]); ?></td>
                    <td><?php echo ($vo["brand_name"]); ?></td>
                    <td><?php echo ($vo["brand_desc"]); ?></td>
                    <td><?php if(empty($vo['brand_logo'])): ?>暂无图片<?php else: ?><img src="/Public/../Uploads/<?php echo ($vo["brand_logo"]); ?>" style="width:100px;height:20px"><?php endif; ?></td>
                <td><?php echo ($vo["site_url"]); ?></td>
                <td><?php echo ($vo["sort"]); ?></td>
                <td>
                    <a href="<?php echo U('Brand/edit',array('id'=>$vo['brand_id']));?>" class="btn btn-secondary btn-sm btn-icon icon-left">
                        编辑
                    </a>
                    <a class="btn btn-danger btn-sm btn-icon icon-left" addr="<?php echo U('Brand/delete',array('id'=>$vo['brand_id']));?>" onclick="if (confirm('确定要删除吗?')) {
                                                                                    window.location.href = $(this).attr('addr');
                                                                                }
                                                                                ;">
                        删除
                    </a>
