                    ...
                    <li><?php endif; ?>
                        ...
                        <!--    <?php if(quanx('sorder',2)): if($_GET['flag']== 'sol'): ?><li class='active'>
                            ...
                            <?php if(quanx('fz_order',2)): if($_GET['flag']== 'fzol'): ?><li class='active'>
                                    <?php else: ?>
                                    <li><?php endif; ?><a href="<?php echo U('Order/index');?>?flag=fzol"><span class="title">分站订单列表 - Sub order list</span></a></li><?php endif; ?>
							<?php if(quanx('fw_order',2)): if($_GET['flag']== 'fol'): ?><li class='active'>
                                    <?php else: ?>
                                    <li><?php endif; ?><a href="<?php echo U('Order/index');?>?flag=fol"><span class="title">推送人订单列表 -Service order list</span></a></li><?php endif; ?>
