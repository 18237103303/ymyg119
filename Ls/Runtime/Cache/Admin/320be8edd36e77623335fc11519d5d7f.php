                        ...
                        <ul>
                           ...
                           <?php if(quanx('spin',2)): if($_GET['flag']== 'glist'){ ?>
                                   ...
                                   <?php }else{ ?>
                                    <li>
                                 <?php } ?>
                                <a href="<?php echo U('Goods/ceshi');?>?flag=glist"><span class="title">商品列表 - Commodity list</span>
                                </a>
                               </li><?php endif; ?>
            ...
            <div class="panel-body">
                <form role="form" class="form-horizontal" action='' method=''>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="biaoti"  value="<?php echo ($data["0"]["arc_title"]); ?>">
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="field-6">公告内容</label>
                        ...
                        <div class="col-sm-10">
                            <textarea  id="goods_desc" name="content"><?php echo ($data["0"]["content"]); ?>
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
                    <div class="form-group">
                        <a  class="btn btn-gray btn-single" href="<?php echo U('Article/bulist');?>">返回</a>
                        <button type="button" class="btn btn-info btn-single pull-right" onclick="edit(<?php echo ($data["0"]["arc_id"]); ?>)">修改</button>
                    </div>
                </form>
            </div>
        </div>
...
<script src="/Public/admin/assets/js/bootbox/bootbox.min.js"></script>
<script src="/Public/admin/assets/js/ckeditor/ckeditor.js"></script>
<script src="/Public/admin/assets/js/ckeditor/adapters/jquery.js"></script>
<script>
                                                                    function edit(id) {
                                                                        ...
                                                                        $.ajax({
                                                                            'type': 'post',
                                                                            'url': "<?php echo U('Article/editbulist');?>",
                                                                            'data': 'arc_title=' + arc_title +'&content=' + content+'&id=' + id,
                                                                            'dataType': 'json',
                                                                            'success': function (dat) {
                                                                                if (dat.status == 1) {
                                                                                    alert('修改成功');
                                                                                    window.location.href="<?php echo U('Article/bulist');?>"
                                                                                } else {
                                                                                    alert('修改失败');
                                                                                }
                                                                            }
