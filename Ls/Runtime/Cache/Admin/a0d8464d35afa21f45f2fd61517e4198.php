        ...
        <div class="page-container">
            ...
            <div class="main-content">
                ...
                <nav class="navbar user-info-navbar" role="navigation">
                 ...
                 <style>
                .maxheight{max-height: 200px; overflow-y: auto;}
            </style>
			<div class="row">
				<div class="col-sm-12">
					<div class="panel panel-default">
							<div class="panel-heading">角色/用户 &nbsp;&nbsp;&nbsp;  auth-user-list</div>

							<div class="panel-body">
								<div class="col-sm-12">
									<div class="col-sm-2">普通会员</div></br>
									<div class="col-sm-10">
									<?php if(is_array($pt_user)): foreach($pt_user as $key=>$vo): ?><a href="/Admin/User/mlist/xq/9/xq_id/<?php echo ($vo["id"]); ?>?flag=user" class="btn xiug btn-secondary btn-sm btn-icon icon-left">
											ID<?php echo ($vo["id"]); ?> - <?php echo ($vo["name"]); ?>
							...
							<div class="panel-body">
								<div class="col-sm-12">
									<div class="col-sm-2">后台管理</div></br>
									<div class="col-sm-10">
											<?php if(is_array($fz_user)): foreach($fz_user as $key=>$vo): ?><a href="/Admin/Zfz/dz/id/<?php echo ($vo["id"]); ?>" class="btn xiug btn-secondary btn-sm btn-icon icon-left">
											ID<?php echo ($vo["id"]); ?> - <?php echo ($vo["name"]); ?>
											</a><?php endforeach; endif; ?>		
									</div>
								</div>
							...
							<div class="panel-body">
								<div class="col-sm-12">
									<div class="col-sm-2">配送合作商</div></br>
									<div class="col-sm-10">
											<?php if(is_array($ps_user)): foreach($ps_user as $key=>$vo): ?><a href="/Admin/User/mlist/xq/9/xq_id/<?php echo ($vo["id"]); ?>?flag=user" class="btn xiug btn-secondary btn-sm btn-icon icon-left">
											ID<?php echo ($vo["id"]); ?> - <?php echo ($vo["name"]); ?>
											</a><?php endforeach; endif; ?>		
									</div>
								</div>
							...
							<div class="panel-body">
								<div class="col-sm-12">
									<div class="col-sm-2">线下专员</div></br>
									<div class="col-sm-10">
											<?php if(is_array($xx_user)): foreach($xx_user as $key=>$vo): ?><a href="/Admin/User/mlist/xq/9/xq_id/<?php echo ($vo["id"]); ?>?flag=user" class="btn xiug btn-secondary btn-sm btn-icon icon-left">
											ID<?php echo ($vo["id"]); ?> - <?php echo ($vo["name"]); ?>
											</a><?php endforeach; endif; ?>		
									</div>
								</div>
                            ...
                            <div class="panel-body">
								<div class="col-sm-12">
									<div class="col-sm-2">财务</div></br>
									<div class="col-sm-10">
											<?php if(is_array($cw_user)): foreach($cw_user as $key=>$vo): ?><a href="/Admin/User/mlist/xq/9/xq_id/<?php echo ($vo["id"]); ?>?flag=user" class="btn xiug btn-secondary btn-sm btn-icon icon-left">
											ID<?php echo ($vo["id"]); ?> - <?php echo ($vo["name"]); ?>
											</a><?php endforeach; endif; ?>
									</div>
								</div>
                            ...
                            <div class="panel-body">
								<div class="col-sm-12">
									<div class="col-sm-2">400客服</div></br>
									<div class="col-sm-10">
											<?php if(is_array($kf_user)): foreach($kf_user as $key=>$vo): ?><a href="/Admin/User/mlist/xq/9/xq_id/<?php echo ($vo["id"]); ?>?flag=user" class="btn xiug btn-secondary btn-sm btn-icon icon-left">
											ID<?php echo ($vo["id"]); ?> - <?php echo ($vo["name"]); ?>
											</a><?php endforeach; endif; ?>
									</div>
								</div>
...
$(function(){
$('.xg').click(function(){
location.href="/Admin/User/mlist";
})
})
</script>		
			
<!-- 选项框JS-->				
<link rel="stylesheet" href="/Public/admin/assets/js/icheck/skins/all.css">
<script src="/Public/admin/assets/js/icheck/icheck.min.js"></script>
<script>
